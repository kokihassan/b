...
# ================= الإعدادات (تأكد من تحديثها من موقع تليجرام) =================
BOT_TOKEN = "1910891378:AAHBvScDJ9O3wECe_Ea_Dt4wr7X7rssWZno"
ADMIN_ID = 1116526399
API_ID = 21504509  # تأكد من تطابق هذا الرقم تماماً مع موقع تليجرام
API_HASH = 'eea80c33959003e176af9fe69fa3ab79' # تأكد من تطابق هذا الكود
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "status":
        txt = "✅ ملفك نشط" if os.path.exists(db) else "❌ لا يوجد ملف"
...
async def handle_msg(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.document:
        ...
        try:
            ...
            # استخدام العميل الجاهز بدلاً من فتحه في كل مرة
            ...
            await msg.edit_text("❌ حدث خطأ برمجـي أثناء التحميل. تأكد من صحة بيانات API.")
